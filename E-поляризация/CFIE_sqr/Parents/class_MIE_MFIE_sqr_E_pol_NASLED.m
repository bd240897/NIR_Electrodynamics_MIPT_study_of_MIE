classdef class_MIE_MFIE_sqr_E_pol_NASLED < class_parent_MIE_sqr
...
% Пример использования:
    ...
    % N= 100;
    %     
    % calc_1 = class_MIE_MFIE_sqr_E_pol_NASLED(as, phi_grad);
...
%% КОНСТРУКТОР - НАСЛЕДОВАНИЕ
        % конструктор
        function obj = class_MIE_MFIE_sqr_E_pol_NASLED(as, phi_grad)
            obj@class_parent_MIE_sqr(as, phi_grad);
            obj.type_MIE = 'MFIE';
        end
%% РАСЧЕТ ТОКОВ       
