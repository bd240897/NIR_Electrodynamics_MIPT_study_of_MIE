classdef P_class_MIE_sqr < handle
...
%% Класс содержит свойства (поля дли них)
    ...
    % Промежуточные данные вывода: Sum_E_mass, Sum_H_mass, Zmn, Hi, Ei (расчет)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % конструктор
        function obj = P_class_MIE_sqr(as, phi_grad)
            obj.as = as;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        function print_sqr(obj) 
            ...
            name_title = strcat("Основной квадрат и его проксимация\_",type_MIE ,"\_",type_pol,"\_sqr");
            title(name_title); 
            name_legend = strcat("class\_",type_MIE,"\_",type_pol,"\_sqr");
            legend(name_legend);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
    % записать токи в файл
        function obj = write_I_to_file(obj)
            ...
            name_file = strcat("I_", type_MIE ,"_MIE_", type_pol, "_sqrt_", num2str(N),".dat");
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
        ...
        function obj =  write_DA_to_file(obj)
            ...
            name_file = strcat("DA_", type_MIE ,"_MIE_", type_pol, "_sqrt_", num2str(N),".dat");
