...
%%
        %% СОБЕРЕМ ВСЕ ВМЕСТЕ
        % cоставляющие Hy1    
%         Hy1 = 1i*k1/eta1*hm_y1 + he_y1;
%         
%         % cоставляющие Hy2  
%         Hy1 = 1i*k2/eta2*hm_y2 + he_y2
%         
%         % cоставляющие E1u
%         E1u = 1i*eta1/k1*(fe_u11 + k^2*fe_u12) + fm_u1;
%         
%         % cоставляющие E2u
%         E2u = 1i*eta2/k2*(fe_u21 + k^2*fe_u22) + fm_u2;
%         
%         % cоставляющие E1w
%         E1w = 1i*eta1/k1*fe_w1 + fm_w1;
%         
%         % cоставляющие E2w
%         E2w = 1i*eta2/k2*fe_w2 + fm_w2;
...
for p = 1 : 721
    ...
    cz = - 1i*k2*sind(phi);
        ...
        for n = 1 : N
            ...
            Sum_H = Sum_H + k2*dx/4*j2(n)*(txn*sind(phi) - tzn*cosd(phi))*exp(cx*xn+cz*zn);  %% проверить!   
